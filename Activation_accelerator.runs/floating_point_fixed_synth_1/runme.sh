...
HD_PWD='/home/anderson/vivado/project/Activation_accelerator/Activation_accelerator.runs/floating_point_fixed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_fixed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_fixed.tcl
