...
//               /home/anderson/vivado/project/Activation_accelerator/Activation_accelerator.gen/sources_1/bd/design_1/ip/design_1_sub_max_0_0/design_1_sub_max_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_sub_max_0_0,sub_max,{}" *) (* CORE_GENERATION_INFO = "design_1_sub_max_0_0,sub_max,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=sub_max,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "sub_max,Vivado 2024.2" *) 
module design_1_sub_max_0_0(aclk, arstn, S_AXIS_TDATA, S_AXIS_TVALID, 
  S_AXIS_TREADY, M_AXIS_TDATA, M_AXIS_TVALID, M_AXIS_TREADY)
/* synthesis syn_black_box black_box_pad_pin="aclk,arstn,S_AXIS_TDATA[143:0],S_AXIS_TVALID,S_AXIS_TREADY,M_AXIS_TDATA[127:0],M_AXIS_TVALID,M_AXIS_TREADY" */;
