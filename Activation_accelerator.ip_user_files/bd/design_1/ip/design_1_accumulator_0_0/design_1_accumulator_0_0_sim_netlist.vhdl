...
-- Date        : Fri Oct 17 10:40:58 2025
-- Host        : Legion running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/anderson/vivado/project/Activation_accelerator/Activation_accelerator.gen/sources_1/bd/design_1/ip/design_1_accumulator_0_0/design_1_accumulator_0_0_sim_netlist.vhdl
-- Design      : design_1_accumulator_0_0
...
entity design_1_accumulator_0_0_gen_tlast is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_accumulator_0_0_gen_tlast : entity is "gen_tlast";
end design_1_accumulator_0_0_gen_tlast;

architecture STRUCTURE of design_1_accumulator_0_0_gen_tlast is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_accumulator_0_0_acc_fifo is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_accumulator_0_0_acc_fifo : entity is "acc_fifo";
end design_1_accumulator_0_0_acc_fifo;

architecture STRUCTURE of design_1_accumulator_0_0_acc_fifo is
  component design_1_accumulator_0_0_c_shift_ram_2 is
  port (
    D : in STD_LOGIC_VECTOR ( 128 downto 0 );
    CLK : in STD_LOGIC;
    CE : in STD_LOGIC;
  ...
  end component design_1_accumulator_0_0_c_shift_ram_2;
...
shift_ram_u: component design_1_accumulator_0_0_c_shift_ram_2
     port map (
      CE => E(0),
      CLK => aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_accumulator_0_0_add8 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_accumulator_0_0_add8 : entity is "add8";
end design_1_accumulator_0_0_add8;

architecture STRUCTURE of design_1_accumulator_0_0_add8 is
  component design_1_accumulator_0_0_floating_point_1 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component design_1_accumulator_0_0_floating_point_1;
  component design_1_accumulator_0_0_floating_point_1_HD1 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    m_axis_result_tready : in STD_LOGIC;
  ...
  end component design_1_accumulator_0_0_floating_point_1_HD1;
...
begin
\STAGE1[0].add_s1\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[1].add_s1\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[2].add_s1\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[3].add_s1\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE2[0].add_s2\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE2[1].add_s2\: component design_1_accumulator_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
add_s3: component design_1_accumulator_0_0_floating_point_1_HD1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_accumulator_0_0_acc is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_accumulator_0_0_acc : entity is "acc";
end design_1_accumulator_0_0_acc;

architecture STRUCTURE of design_1_accumulator_0_0_acc is
  component design_1_accumulator_0_0_floating_point_2 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_a_tvalid : in STD_LOGIC;
  ...
  end component design_1_accumulator_0_0_floating_point_2;
  component design_1_accumulator_0_0_c_shift_ram_1 is
  port (
    D : in STD_LOGIC_VECTOR ( 127 downto 0 );
    CLK : in STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 127 downto 0 )
  );
  end component design_1_accumulator_0_0_c_shift_ram_1;
...
acc_u: component design_1_accumulator_0_0_floating_point_2
     port map (
      aclk => aclk,
      aresetn => arstn,
...
add8_u: entity work.design_1_accumulator_0_0_add8
     port map (
...
gen_last_u: entity work.design_1_accumulator_0_0_gen_tlast
     port map (
      D(15 downto 0) => tdata_add2last(15 downto 0),
...
shift_ram_u: component design_1_accumulator_0_0_c_shift_ram_1
     port map (
      CLK => aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_accumulator_0_0_accumulator is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_accumulator_0_0_accumulator : entity is "accumulator";
end design_1_accumulator_0_0_accumulator;

architecture STRUCTURE of design_1_accumulator_0_0_accumulator is
...
acc_u: entity work.design_1_accumulator_0_0_acc
     port map (
      E(0) => acc_data_reg0,
...
fifo_u: entity work.design_1_accumulator_0_0_acc_fifo
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_accumulator_0_0 is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_accumulator_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_accumulator_0_0 : entity is "design_1_accumulator_0_0,accumulator,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_accumulator_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_accumulator_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_accumulator_0_0 : entity is "accumulator,Vivado 2024.2";
end design_1_accumulator_0_0;

architecture STRUCTURE of design_1_accumulator_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of M_AXIS_TDATA : signal is "XIL_INTERFACENAME M_AXIS, TDATA_NUM_BYTES 18, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN design_1_aclk_0, LAYERED_METADATA undef, INSERT_VIP 0";
...
begin
inst: entity work.design_1_accumulator_0_0_accumulator
     port map (
