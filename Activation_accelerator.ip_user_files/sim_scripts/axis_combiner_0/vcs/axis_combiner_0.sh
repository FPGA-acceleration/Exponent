...
design_libs=(xpm axis_infrastructure_v1_1_1 axis_combiner_v1_1_31 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_combiner_v1_1_31 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
...
reset_run()
{
  files_to_remove=(ucli.key axis_combiner_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_combiner_0_simv.daidir vcs_lib c.obj)
