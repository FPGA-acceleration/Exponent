...
#
# Script generated by Vivado on Wed Oct 15 21:49:27 CST 2025
...
#
# Usage        : axis_combiner_0.sh
#                axis_combiner_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_combiner_0.sh [-reset_run]
#                axis_combiner_0.sh [-reset_log]
#                axis_combiner_0.sh [-help]
#
...
#                script (type 'axis_combiner_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_combiner_v1_1_31 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axis_infrastructure_v1_1_1 axis_combiner_v1_1_31 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_combiner_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_combiner_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axis_combiner_v1_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_combiner_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_combiner_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_combiner_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axis_combiner_0.sh [-step]\n\
Usage: axis_combiner_0.sh [-lib_map_path]\n\
Usage: axis_combiner_0.sh [-reset_run]\n\
Usage: axis_combiner_0.sh [-reset_log]\n\
Usage: axis_combiner_0.sh [-keep_index]\n\
