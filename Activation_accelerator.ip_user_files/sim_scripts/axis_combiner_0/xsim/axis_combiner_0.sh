...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_combiner_v1_1_31 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_combiner_0 xil_defaultlib.axis_combiner_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_combiner_0 -key {Behavioral:sim_1:Functional:axis_combiner_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_combiner_0.wdb xsim.dir libdpi.so)
