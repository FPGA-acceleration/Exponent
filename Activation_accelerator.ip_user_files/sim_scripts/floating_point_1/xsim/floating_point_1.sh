...
#
# Script generated by Vivado on Thu Oct 16 19:42:38 CST 2025
...
simulate()
{
  xsim floating_point_1 -key {Behavioral:sim_1:Functional:floating_point_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
