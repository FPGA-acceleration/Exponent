...
#
# Script generated by Vivado on Fri Oct 17 10:13:22 CST 2025
...
simulate()
{
  xsim c_shift_ram_2 -key {Behavioral:sim_1:Functional:c_shift_ram_2} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
