...
#
# Script generated by Vivado on Thu Oct 16 21:05:02 CST 2025
...
simulate()
{
  xsim c_shift_ram_1 -key {Behavioral:sim_1:Functional:c_shift_ram_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
