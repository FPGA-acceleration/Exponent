...
#
# Script generated by Vivado on Thu Oct 16 10:03:54 CST 2025
...
simulate()
{
  xsim axis_broadcaster_0 -key {Behavioral:sim_1:Functional:axis_broadcaster_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
